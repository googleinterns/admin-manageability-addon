...
* @param {String} projectType is the enum having values {SYSTEM_PROJECT, ALL_PROJECT, SPECIFIC_PROJECT, CUSTOM_PROJECT}
...
function getTokenFromAPI(fromTime , projectType, projectId, urlEnd) {
  ...
  var response = UrlFetchApp.fetch('http://34.87.99.232/'+urlEnd, options);
