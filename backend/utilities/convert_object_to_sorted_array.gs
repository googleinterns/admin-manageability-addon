 ...
 * @param {Object} processIdWithExecutions will have key value pair with 
...
/**
 * Convert JSON object to array sorted in descending order of their values
 * @param {Object} userIdWithExecutions will have key value pair with 
 *    key as user id and value as number of executions
 * @return {Object} Sorted Array of the JSON object having 
 *    key as UserId value as execution count in descending order
 */
